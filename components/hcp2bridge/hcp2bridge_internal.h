...
static constexpr uint32_t HCP2BRIDGE_REALTIME_TASK_STACK_BYTES = 6144;
static constexpr uint32_t HCP2BRIDGE_REALTIME_MAINT_TASK_STACK_BYTES = 4096;
static constexpr uint32_t HCP2BRIDGE_HTTP_TASK_STACK_BYTES = 8192;
static constexpr uint32_t HCP2BRIDGE_HTTP_HP_ACTION_TASK_STACK_BYTES = 3072;
static constexpr uint32_t HCP2BRIDGE_HTTP_HP_ACTION_DELAY_MS = 250;
static constexpr uint32_t HCP2BRIDGE_HTTP_HP_ACTION_MIN_UPTIME_MS = 70000;
...
static constexpr uint32_t HCP2BRIDGE_CONTINUITY_GOOD_CLEAR_MS = 3000;
